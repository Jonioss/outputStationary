...
#pragma HLS INTERFACE m_axi port=B_DRAM bundle=gmem1
	...
	fm_t B_BUF[NUM_OF_TILES][K][J/NUM_OF_TILES]; 2
	...
	fm_t C_BUF[NUM_OF_TILES][NUM_OF_TILES][I/NUM_OF_TILES][J/NUM_OF_TILES]; 4
	...
	fm_t A_TILE[I/NUM_OF_TILES][K]; 2
	...
	fm_t B_TILES[NUM_OF_TILES][K][J/NUM_OF_TILES]; 2
...
//#pragma HLS INLINE
	...
	for(int tileA = 0; tileA < NUM_OF_TILES; tileA++) {
		#pragma HLS DATAFLOW
		fm_t C_TILES[NUM_OF_TILES][I/NUM_OF_TILES][J/NUM_OF_TILES]; 2
